...
For å kalle applikasjonen fra frontend må du sette miljøvariablene AZURE_APP_CLIENT_ID og AZURE_APP_CLIENT_SECRET. Dette kan gjøres
under `Edit Configurations -> Environment Variables`. Verdiene ligger i secreten `azuread-familie-ks-sak-lokal` i
...
```
nais secret get azuread-familie-ks-sak-lokal -e dev-gcp -t teamfamilie --with-values --reason "Lokal utvikling av familie-ks-sak"
```
