    ...
    fun lesOgArkiver(uuid: UUID) {
        ...
        if (barnehagelisteMottatt != null) {
            ...
            val barnehagelister = barnehagelisteMelding.skjema.barnInfolinjer.map { it ->
                it.tilBarnehagelisteEntitet(kommuneNavn = barnehagelisteMelding.skjema.listeopplysninger.kommuneNavn,
                    kommuneNr = barnehagelisteMelding.skjema.listeopplysninger.kommuneNr, arkivReferanse = barnehagelisteMottatt.meldingId)
            }
