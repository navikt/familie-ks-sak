 ...
 * Antakelsen er at IKKE_AKTUELT i ALLE tilfeller kan ignoreres for beregning,
 ...
 */
fun Iterable<VilkårResultat>.tilVilkårRegelverkResultatTidslinje() = this.filter { it.erOppfylt() || it.erIkkeAktuelt() }
    .map { it.tilPeriode() }
