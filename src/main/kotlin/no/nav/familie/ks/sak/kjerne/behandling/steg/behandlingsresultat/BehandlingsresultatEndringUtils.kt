    ...
    internal fun utledEndringsresultat(
        ...
        val endringerForRelevantePersoner =
            relevantePersoner.any { aktør ->
                ...
                val nåværendeEndretAndelerForPerson = nåværendeEndretAndeler.filter { it.aktører.contains(aktør) }
                val forrigeEndretAndelerForPerson = forrigeEndretAndeler.filter { it.aktører.contains(aktør) }
