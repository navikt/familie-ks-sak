...
import no.nav.familie.ks.sak.sikkerhet.SikkerhetContext.erMaskinTilMaskinToken
import no.nav.familie.ks.sak.sikkerhet.SikkerhetContext.erSystemKontekst
import no.nav.familie.ks.sak.sikkerhet.SikkerhetContext.harRolle
import no.nav.familie.ks.sak.sikkerhet.SikkerhetContext.hentGrupper
import no.nav.familie.ks.sak.sikkerhet.SikkerhetContext.hentHøyesteRolletilgangForInnloggetBruker
import no.nav.familie.ks.sak.sikkerhet.SikkerhetContext.hentRolletilgangFraSikkerhetscontext
import no.nav.familie.ks.sak.sikkerhet.SikkerhetContext.hentSaksbehandler
