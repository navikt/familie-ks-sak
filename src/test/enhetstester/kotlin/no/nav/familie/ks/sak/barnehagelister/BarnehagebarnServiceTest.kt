...
class BarnehagebarnServiceTest {
    ...
    @Test
    fun `hentBarnehageBarn skal hente barn i løpende fagsak fra ident dersom det sendes inn som parameter`() {
        // Arrange
    ...
    @Test
    fun `hentBarnehageBarn skal hente barn i uavhengig av fagsak fra ident dersom det sendes inn som parameter`() {
        // Arrange
        val mocketPageBarnehagebarnDtoInterface = mockk<Page<BarnehagebarnDtoInterface>>()
        val barnehagebarnRequestParamsMedIdent =
            BarnehagebarnRequestParams(
    ...
    @Test
    fun `hentBarnehageBarn skal hente barn i løpende fagsak fra kommunenavn dersom det sendes inn som parameter`() {
        // Arrange
        val mocketPageBarnehagebarnDtoInterface = mockk<Page<BarnehagebarnDtoInterface>>()
    ...
    @Test
    fun `hentBarnehageBarn skal hente barn i uavhengig av fagsak fra kommunenavn dersom det sendes inn som parameter`() {
        // Arrange
        val mocketPageBarnehagebarnDtoInterface = mockk<Page<BarnehagebarnDtoInterface>>()
        val barnehagebarnRequestParamsMedKommuneNavn =
            BarnehagebarnRequestParams(
    ...
    @Test
    fun `hentBarnehageBarn skal hente alle barn i løpende fagsaker dersom det sendes inn som parameter`() {
        // Arrange
        val mocketPageBarnehagebarnDtoInterface = mockk<Page<BarnehagebarnDtoInterface>>()
    ...
    @Test
    fun `hentBarnehageBarn skal hente alle barn uavhengig av fagsak dersom det sendes inn som parameter`() {
        // Arrange
        val mocketPageBarnehagebarnDtoInterface = mockk<Page<BarnehagebarnDtoInterface>>()
        val barnehagebarnRequestParams =
            BarnehagebarnRequestParams(
    ...
    @Test
    fun `hentBarnehagebarnInfotrygd skal hente barn fra infotrygd i løpende fagsak fra ident dersom det sendes inn som parameter`() {
        // Arrange
        ...
        assertThat(hentetMocketPageBarnehagebarnDtoInterface.content.size).isEqualTo(1)
    ...
    @Test
    fun `hentBarnehagebarnInfotrygd skal hente barn fra infotrygd uavhengig av fagsak fra kommunenavn dersom det sendes inn som parameter`() {
        // Arrange
        val mocketBarnehagebarnInfotrygdDtoInterface =
            opprettMocketBarnehagebarnInfotrygdDtoInterface(
                "ident1",
    ...
    @Test
    fun `hentBarnehagebarnInfotrygd skal hente barn fra infotrygd i løpende fagsak fra kommunenavn dersom det sendes inn som parameter`() {
        // Arrange
        val mocketBarnehagebarnInfotrygdDtoInterface =
            opprettMocketBarnehagebarnInfotrygdDtoInterface(
                "ident1",
    ...
    @Test
    fun `hentBarnehagebarnInfotrygd skal hente barn fra infotrygd uavhengig av fagsak fra ident dersom det sendes inn som parameter`() {
        // Arrange
        val mocketBarnehagebarnInfotrygdDtoInterface =
            opprettMocketBarnehagebarnInfotrygdDtoInterface(
                "ident1",
    ...
    @Test
    fun `hentBarnehagebarnInfotrygd skal hente alle barn fra infotrygd i løpende fagsak dersom det sendes inn som parameter`() {
        // Arrange
        val mocketBarnehagebarnInfotrygdDtoInterface =
            opprettMocketBarnehagebarnInfotrygdDtoInterface(
                "ident1",
    ...
    @Test
    fun `hentBarnehagebarnInfotrygd skal hente alle barn fra infotrygd uavhengig av fagsak dersom det sendes inn som parameter`() {
        // Arrange
        val mocketBarnehagebarnInfotrygdDtoInterface =
            opprettMocketBarnehagebarnInfotrygdDtoInterface(
                "ident1",
