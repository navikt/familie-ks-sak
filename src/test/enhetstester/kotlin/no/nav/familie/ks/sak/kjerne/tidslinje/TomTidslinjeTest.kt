...
import no.nav.familie.ks.sak.kjerne.tidslinje.komposisjon.TomTidslinje
import no.nav.familie.ks.sak.kjerne.tidslinje.komposisjon.kombinerMed
import no.nav.familie.ks.sak.kjerne.tidslinje.tid.Dag
import no.nav.familie.ks.sak.kjerne.tidslinje.tid.DagTidspunkt
import no.nav.familie.ks.sak.kjerne.tidslinje.tid.Måned
import no.nav.familie.ks.sak.kjerne.tidslinje.tid.PRAKTISK_SENESTE_DAG
import no.nav.familie.ks.sak.kjerne.tidslinje.tid.PRAKTISK_TIDLIGSTE_DAG
import no.nav.familie.ks.sak.kjerne.tidslinje.tid.Uendelighet
import no.nav.familie.ks.sak.kjerne.tidslinje.util.jan
import no.nav.familie.ks.sak.kjerne.tidslinje.util.somBoolskTidslinje
