...
class OpprettGrunnlagOgSignaturDataServiceTest {
    ...
    inner class OpprettGrunnlagOgSignaturData {
        ...
        @Test
        fun `skal bruke innlogget saksbehandler og Beslutter når steg er etter BESLUTTE_VEDTAK`() {
            // Arrange
            val behandling =
                lagBehandling(
        ...
        @Test
        fun `skal kaste Feil når behandling er i et steg før BESLUTTE_VEDTAK og ingen andre betingelser matcher`() {
            // Arrange
            val behandling =
                lagBehandling(
                    lagBehandlingStegTilstander = {
