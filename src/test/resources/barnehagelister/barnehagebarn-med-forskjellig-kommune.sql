...
--To barn med forskjellig ident og kommune. Ene barnet har to records i barnehagelister der kommunenavnet er skrevet i caps i ett av dem
...
INSERT INTO barnehagebarn(id, ident, fom, tom, antall_timer_i_barnehage, kommune_navn, kommune_nr, arkiv_referanse, endret_tid) VALUES ('e7de9709-7817-4f3e-a822-5d4ca49a6914', '12345678901', CURRENT_DATE, CURRENT_DATE + INTERVAL '2 months', 30, 'Oslo', '1', '8769', CURRENT_TIMESTAMP - INTERVAL '1 months');
INSERT INTO barnehagebarn(id, ident, fom, tom, antall_timer_i_barnehage, kommune_navn, kommune_nr, arkiv_referanse, endret_tid) VALUES ('a7de9709-7817-4f3e-a822-5d4ca49a6914', '12345678901', CURRENT_DATE, CURRENT_DATE + INTERVAL '1 months',30, 'OSLO', '1', '9876', CURRENT_TIMESTAMP);
INSERT INTO barnehagebarn(id, ident, fom, tom, antall_timer_i_barnehage, kommune_navn, kommune_nr, arkiv_referanse, endret_tid) VALUES ('b7f7f13b-f145-420b-96cc-88a6a6da230f', '23456789012', CURRENT_DATE, CURRENT_DATE + INTERVAL '2 months', 30, 'Moss', '1', '8769', CURRENT_TIMESTAMP - INTERVAL '1 months');
