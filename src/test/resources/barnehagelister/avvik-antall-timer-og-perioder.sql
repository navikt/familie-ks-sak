...
--har forskjellig antall timer i barnehagebarn og vilkårresultat (har avvik) og løpende andeler og bor i Oslo
...
--har ikke avvik men har løpende andeler og bor i Moss
INSERT INTO aktoer(aktoer_id) VALUES ('2345');
--har avvik men ikke løpende andeler og bor i Moss
INSERT INTO aktoer(aktoer_id) VALUES ('4567');
--Legger inn et barnehagebarn som ikke er blitt registrert enda (ikke har noen fagsak)
...
INSERT INTO vilkar_resultat(id, vilkar, periode_fom, periode_tom, resultat, fk_person_resultat_id, fk_behandling_id, antall_timer) VALUES (3, 'BARNEHAGEPLASS', CURRENT_TIMESTAMP - INTERVAL '3 months', CURRENT_TIMESTAMP, 'OPPFYLT', 1, 1, 15);
...
INSERT INTO andel_tilkjent_ytelse(id, fk_behandling_id, tilkjent_ytelse_id, fk_aktoer_id, kalkulert_utbetalingsbelop, stonad_fom, stonad_tom, type, sats, prosent) VALUES (3, 1, 1, '1234', 100, CURRENT_TIMESTAMP - INTERVAL '3 months', CURRENT_TIMESTAMP - INTERVAL '1 months', 'ORDINÆR_KONTANTSTØTTE', 100, 100);
INSERT INTO andel_tilkjent_ytelse(id, fk_behandling_id, tilkjent_ytelse_id, fk_aktoer_id, kalkulert_utbetalingsbelop, stonad_fom, stonad_tom, type, sats, prosent) VALUES (4, 1, 1, '4567', 100, CURRENT_TIMESTAMP - INTERVAL '3 months', CURRENT_TIMESTAMP - INTERVAL '1 months', 'ORDINÆR_KONTANTSTØTTE', 100, 100);
...
INSERT INTO barnehagebarn(id, ident, fom, tom, antall_timer_i_barnehage, kommune_navn, kommune_nr, arkiv_referanse, endret_tid) VALUES ('b7f7f13b-f145-420b-96cc-88a6a6da230f', '23456789012', CURRENT_DATE, CURRENT_DATE + INTERVAL '2 months',30, 'Moss', '1', '8769', CURRENT_TIMESTAMP - INTERVAL '3 days');
...
INSERT INTO barnehagebarn(id, ident, fom, tom, antall_timer_i_barnehage, kommune_navn, kommune_nr, arkiv_referanse, endret_tid) VALUES ('d7f7f13b-f145-420b-96cc-88a6a6da230f', '45678901234', CURRENT_DATE - INTERVAL '3 months', CURRENT_DATE - INTERVAL '1 months',30, 'MOSS', '1', '7698', CURRENT_TIMESTAMP - INTERVAL '1 days');
