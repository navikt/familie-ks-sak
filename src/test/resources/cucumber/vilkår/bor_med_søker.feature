...
Egenskap: Bor med søker
  ...
  Scenario: Man skal ha rett til kontantstøtte fra og med måned man har fått innvilget vilkåret bor med søker til og med siste måned.
    ...
    Og følgende vilkårresultater for behandling 1
      ...
      | 2       | BOR_MED_SØKER                            |                  | 05.10.2024 | 05.07.2025 | OPPFYLT  | Nei                  |                      |                |
      | 2       | MEDLEMSKAP_ANNEN_FORELDER,BOSATT_I_RIKET |                  | 05.01.2023 |            | OPPFYLT  | Nei                  |                      |                |
      | 2       | BARNEHAGEPLASS                           |                  | 05.02.2024 |            | OPPFYLT  | Nei                  |                      |                |
