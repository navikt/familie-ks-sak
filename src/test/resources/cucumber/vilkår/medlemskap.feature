...
Egenskap: Medlemskap
  ...
  Scenario: Man skal ha rett til kontantstøtte fra og med måned man har fått innvilget medlemskap og til og med siste måned.
    ...
    Og følgende vilkårresultater for behandling 1
      ...
      | 1       | BOSATT_I_RIKET,LOVLIG_OPPHOLD                          |                  | 19.06.1988 |            | OPPFYLT  | Nei                  |                      |                |
      | 1       | MEDLEMSKAP                                             |                  | 05.11.2024 | 05.12.2024 | OPPFYLT  | Nei                  |                      |                |
