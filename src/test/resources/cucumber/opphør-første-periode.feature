...
Egenskap: Opphør første periode
  ...
  Scenario: Når det er opphør første periode, men vi har vilkårresultat før den første, ønsker vi fortsatt å få opphørstekster for første periode
    ...
    Og når disse begrunnelsene er valgt for behandling 2
      ...
      | 01.09.2023 | 31.07.2024 | OPPHØR_VURDERING_IKKE_BOSATT_I_NORGE, OPPHØR_IKKE_BOSATT_I_NORGE, OPPHØR_FLYTTET_FRA_NORGE |                 |            |


    Så forvent følgende brevbegrunnelser for behandling 2 i periode 01.09.2023 til 31.07.2024
      | Begrunnelse                          | Type     | Antall barn | Gjelder søker | Beløp | Søknadstidspunkt | Måned og år begrunnelsen gjelder for | Avtale tidspunkt delt bosted | Søkers rett til utvidet |
      | OPPHØR_VURDERING_IKKE_BOSATT_I_NORGE | STANDARD | 1           | ja            | 0     |                  | september 2023                       |                              |                         |
      | OPPHØR_IKKE_BOSATT_I_NORGE           | STANDARD | 1           | ja            | 0     |                  | september 2023                       |                              |                         |
      | OPPHØR_FLYTTET_FRA_NORGE             | STANDARD | 1           | ja            | 0     |                  | september 2023                       |                              |                         |