...
TODO():
    fun sdfsd() {
        ...
        val barnICache = barnehagebarnService.hentBarnehagebarnDtoer()

        barnehagebarnService.lagreBarnehageBarn(barnehagebarn.copy(id = UUID.randomUUID(), ident = "98765432109"))

        val oppdatertCache = barnehagebarnService.hentBarnehagebarnDtoer()

        assertThat(barnICache).isNotEqualTo(oppdatertCache)
    }
